 ...
 * MPU9250AHRS.h
 *
 * Derived from "MPU9250 Basic Example Code" by Kris Winer
...
#ifndef MPU9250AHRS_H_
#define MPU9250AHRS_H_
 ...
 */
class MPU9250AHRS : public Instrument {
  // Bias corrections for gyro and accelerometer
  float gyroBias[3] = {0, 0, 0};
  float accelBias[3] = {0, 0, 0};
  // Factory mag calibration and mag bias
  float magCalibration[3] = {0, 0, 0};
  float magbias[3] = {-60.0, 190.0, 0};
